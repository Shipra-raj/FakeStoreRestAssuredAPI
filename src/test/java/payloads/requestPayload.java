...
public class requestPayload {
	...
	private static final String categories[] = { "electronics", "furniture", "clothing", "books" };
	...
	public static Product productPayload() {
		...
		String imgUrl = "axy.jpg";
		String category = categories[random.nextInt(categories.length)];

		// Now, assign the above created data to POJO Class

		Product prd = new Product(title, price, description, imgUrl, category);
		return prd;
	}
